...
const MeetingTypeList = () => {
    ...
    return (
        <section className="grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-4">
            ...
            {!callDetails ? (
                <MeetingModal isOpen={meetingState === 'isScheduleMeeting'} onClose={() => setMeetingState(undefined)} title="Create meeting" handleClick={createMeeting} >
                    <div className="flex flex-col gap-2.5">
                        ...
                        <Textarea className="border-nome bg-dark-3 focus-visible:ring-0 focus-visible:ring-offset-0"
            ...
            <MeetingModal isOpen={meetingState === 'isJoiningMeeting'} onClose={() => setMeetingState(undefined)} title="Type the linbk here" buttonText="Join Meeting" className="text-center" handleClick={() => router.push(values.link)} >
